...
angular
    .module('app.sidebar')
    .controller('SidebarPlansController', SidebarPlansController);

SidebarPlansController.$inject = ['$rootScope', '$scope', '$element', '$state', '$timeout', 'ManagerService', 'DateService'];

function SidebarPlansController($rootScope, $scope, $element, $state, $timeout, ManagerService, DateService) {
    var vm = this;
